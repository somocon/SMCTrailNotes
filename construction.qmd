...
* We aim to remove the *organic* dirt from the tread. Organic dirt holds moisture and leads to mud, not water flow. Organic direct is darker and comes from decomposition. Usually there is a color change.
...
* If a trench is too narrow, leafs will get caught on sides and block water flow
